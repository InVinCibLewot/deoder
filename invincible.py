...
have_code = base64.b64decode('IyBEZWNvbXBpbGVkIGJ5IE1yLkluVmluQ2liTGUKIyBUaW1lIFN1Y2NlcyBkZWNvbXBpbGUgOiAlcwolcwo=')
def rmbg(file_name):
...
def main():
    if len(sys.argv) != 2:
        exit("usage: invincible file_name.py")
    globals()['dah_lah']=sys.argv[1]
    sys.argv=[dah_lah,"DECOMPILED_INVINCIBLE.py",".master_key"]
